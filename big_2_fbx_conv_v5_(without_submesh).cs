// использовано много лишних тегов со свойствами
// они были просто скопированы из другого fbx-файла 
// их можно удалить, но они могут пригодится
...
// проблема - всё таки сабмеши нужны , если делать меш всеми гранями подряд , то невозможно будет наложить текстуру на её часть 
